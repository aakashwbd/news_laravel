        ...
        <div class="form-group mt-5">
            <div class="smtp">
                ...
                <label class="container">Gmail SMTP
                    <input type="radio" <?php echo e(($target->name === "gmail") ? 'checked' : null); ?> name="smtp" value="gmail">
                    <span class="checkmark"></span>
                </label>
                <label class="container">Server SMTP
                    <input type="radio" name="smtp" value="server" <?php echo e(($target->name === "server") ? 'checked' : null); ?>>
                    <span class="checkmark"></span>
                </label>
            </div>
        </div>
...
<script>
    $(function () {
        ...
        $(document).on("click", "#updateSmtp", function (e) {
            ...
            var url = "<?php echo e(URL::to('admin/smtp/update')); ?>"
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tausif/Desktop/rupom/mainProject/news_app/resources/views/smtp/edit.blade.php ENDPATH**/ ?>