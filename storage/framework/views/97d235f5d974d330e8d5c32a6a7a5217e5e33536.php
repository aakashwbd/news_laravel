                        ...
                        <div class="file-upload-content-edit">
                            <?php if($target->logo): ?>
                                <img class="file-upload-image-edit"
                                     src="<?php echo e(URL::to('/')); ?>/uploads/<?php echo e($target->logo); ?>" alt="your image" />
                            <?php endif; ?>
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tausif/Desktop/rupom/mainProject/news_app/resources/views/settings/basicSettings.blade.php ENDPATH**/ ?>