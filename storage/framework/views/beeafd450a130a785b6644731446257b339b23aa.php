<?php $__env->startSection('data_count'); ?>
    ...
    <div class="content-heading">
        ...
        <div class="row">
            ...
            <div class="col-md-2 content-title">
                <a href="<?php echo e(url('admin/report/news')); ?>">News Report</a>
                    ...
                    <?php $__currentLoopData = $target; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="table-actions text-center">
                                    ...
                                    <button onclick="deleteItem('<?php echo e(URL::to('admin/report/' . $data->report_id)); ?>')" title="Delete" id="news">
...
<?php $__env->startPush('custom-js'); ?>
    ...
    <script type="text/javascript">
        $(document).on("change", ".onoffswitch-checkbox", function(e) {
            ...
            $.ajax({
                url: "<?php echo e(URL::to('/admin/report/status')); ?>",
                type: "POST",
                dataType: "json",
                headers: {
        ...
        $(document).on("click", "#reportShow", function(e) {
            ...
            $(`.view-${id}`).html('viewed')
            $.ajax({
                url: "<?php echo e(URL::to('/admin/report/report-show')); ?>",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tausif/Desktop/rupom/mainProject/news_app/resources/views/report/index.blade.php ENDPATH**/ ?>