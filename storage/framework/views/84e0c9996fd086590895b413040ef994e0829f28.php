    ...
    <div class="content-heading">
        <div class="row">
            ...
            <div class="col-md-4 text-right">
                <form action="<?php echo e(url('/admin/admin/filter')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <?php $__currentLoopData = $target; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="table-actions text-center">
                                    ...
                                    <button onclick="deleteItem('<?php echo e(URL::to('admin/admin/' . $data->id)); ?>')" title="Delete" id="news">
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tausif/Desktop/rupom/mainProject/news_app/resources/views/admin/adminIndex.blade.php ENDPATH**/ ?>