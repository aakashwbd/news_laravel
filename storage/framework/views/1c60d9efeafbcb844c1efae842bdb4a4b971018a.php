    ...
    <div class="content-heading">
        ...
        <div class="row">
            ...
            <div class="col-md-2 content-title">
                <span class="title">News Comments</span>
                <div class="title-line"></div>
            </div>

            <div class="col-md-2 content-title">

                <span class="title"><a href="<?php echo e(url('/admin/comment')); ?>">Video Comment</a></span>
                    ...
                    <?php $__currentLoopData = $target; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="table-actions text-center">
                                    <button onclick="deleteItem('<?php echo e(URL::to('admin/comment/news/' . $data->comment_id)); ?>')" title="Delete" id="news">
...
<?php $__env->startPush('custom-js'); ?>
    ...
    <script type="text/javascript">
        $(document).on("change", ".onoffswitch-checkbox", function(e) {
            ...
            $.ajax({
                url: "<?php echo e(URL::to('admin/comment/news/status')); ?>",
                type: "POST",
                dataType: "json",
                headers: {
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tausif/Desktop/rupom/mainProject/news_app/resources/views/comment/news.blade.php ENDPATH**/ ?>