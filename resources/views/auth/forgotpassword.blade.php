...
>>>>>>> origin/admin-panel
                                    ...
                                    <h6 class="text-center my-5">Didn’t get code? <span class="text-danger">Resend</span>
                                    </h6>
    ...
    <script>
        ...
        $(function () {
            $(document).on("click", "#forgotPassword", function (e) {
                ...
                $.ajax({
                    url: "{{ URL::to('api/v1/auth/user/forgot-password') }}",
                    type: 'POST',
                    dataType: "json",
                    processData: false,
                    contentType: false,
...
>>>>>>> origin/admin-panel
                ...
                $.ajax({
                    url: "{{ URL::to('api/v1/auth/user/user-verify') }}",
                    type: 'POST',
                    dataType: "json",
                    processData: false,
                    contentType: false,
            ...
            $(document).on("click", "#recoverPass", function (e) {
                ...
                $.ajax({
                    url: "{{ URL::to('api/v1/auth/user/change-password') }}",
                    type: 'POST',
                    dataType: "json",
                    processData: false,
                    contentType: false,
