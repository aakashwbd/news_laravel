    ...
    <div class="content-heading">
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-6 text-right">
                <form action="{{url('admin/video/news/filter')}}" method="POST" enctype="multipart/form-data">
                    @csrf
            ...
            <div class="col-md-3 col-sm-6 col-6">
                ...
                <a href="{{url('admin/video/news/create')}}">
            ...
            @if (!$target->isEmpty())
                @foreach ($target as $data)
                    @if ($viewData)
                        ...
                        <a href="{{ url('admin/video/news/edit', $data->id) }}" class="button">
                        ...
                        <button onclick="deleteItem('{{ URL::to('admin/video/news/' . $data->id) }}')" title="Delete"
                                id="news">
...
@push('custom-js')
    <script>
        $(document).on("change", "#approval", function (e) {
            ...
            var url = "{{ URL::to('admin/video/manage-videoApproval') }}"
