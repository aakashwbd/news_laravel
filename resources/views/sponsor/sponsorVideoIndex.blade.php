        ...
        <div class="row">
            ...
            <div class="col-md-8 content-title">
                <div class="row">
                    <div class="col-md-2">
                        <span class="title">
                            <a href="/sponsor" class="title-btn">Sponsor Banner</a>
                        </span>
                        <div class="title-line category-title-line display-none" id="categoryLine"></div>
                    </div>
                    <div class="col-md-2">
                        <span class="sub-title">
                            <a href="/sponsor/sponsor-video-index" class="title-btn red">Sponsor Video</a>
                        </span>
            ...
            <div class="col-md-4 text-right">
                <form action="/sponsor/sponsor-video-filter" method="POST" enctype="multipart/form-data">
                    @csrf
            ...
            @foreach ($target as $data)
                <div class="margin-top-40 col-md-2">
                    ...
                    <div class="country-action text-center margin-top-10">
                        <form action="{{ URL::to('sponsor/' . $data->id . '/sponsor-video-index') }}" method="POST">
                            @csrf
                            @method('DELETE')
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $(document).on("click", "#editBtn", function(e) {
                ...
                $.ajax({
                    url: "{{ URL::to('sponsor/sponsor-video-edit') }}",
                    type: "POST",
                    dataType: "json",
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            ...
            $(document).on("click", "#editSponsorVideo", function(e) {
                ...
                $.ajax({
                    url: "{{ URL::to('sponsor/sponsor-video-update') }}",
                    type: 'POST',
                    dataType: "json",
                    processData: false,
                    contentType: false,
