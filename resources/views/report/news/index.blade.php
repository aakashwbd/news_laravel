...
{{--        <button class="btn cs-btn" style="display: inline-block"><a href="/report">Video News Report</a></button>--}}
        <div class="row">
            {{-- title --}}
            ...
            <div class="col-md-2 content-title">
                ...
                <a href="{{url('/admin/report')}}">Video News Report</a>
                    ...
                    @foreach ($target as $data)
                        ...
                        <tr>
                            ...
                            <td class="table-actions text-center">
                                    ...
                                    <button onclick="deleteItem('{{ URL::to('admin/report/news' . $data->report_id) }}')" title="Delete" id="news">
...
@push('custom-js')
    ...
    <script type="text/javascript">
        $(document).on("change", ".onoffswitch-checkbox", function(e) {
            ...
            $.ajax({
                url: "{{ URL::to('admin/report/news/status') }}",
                type: "POST",
                dataType: "json",
                headers: {
        ...
        $(document).on("click", "#reportShow", function(e) {
            ...
            $(`.view-${id}`).html('viewed')
            $.ajax({
                url: "{{ URL::to('admin/report/news/report-show') }}",
                type: "POST",
                dataType: "json",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
