...
{{--           <button class="btn cs-btn" style="display: inline-block"><a href="/comment">Video Comment</a></button>--}}
        <div class="row">
            {{-- title --}}
            ...
            <div class="col-md-2 content-title">
                ...
                <span class="title"><a href="{{url('/admin/comment')}}">Video Comment</a></span>
                    ...
                    @foreach ($target as $data)
                        <tr>
                            ...
                            <td class="table-actions text-center">
                                    <button onclick="deleteItem('{{ URL::to('admin/comment/news/' . $data->comment_id) }}')" title="Delete" id="news">
...
@push('custom-js')
    ...
    <script type="text/javascript">
        $(document).on("change", ".onoffswitch-checkbox", function(e) {
            ...
            $.ajax({
                url: "{{ URL::to('admin/comment/news/status') }}",
                type: "POST",
                dataType: "json",
                headers: {
